...
public class AboutUsActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lan.nicehair.activity.AboutUsActivity target, Object source) {
    View view;
  ...
  public static void reset(com.lan.nicehair.activity.AboutUsActivity target) {
    target.mTopBar = null;
  }
}
